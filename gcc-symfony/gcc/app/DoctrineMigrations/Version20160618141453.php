 ...
 */
class Version20160618141453 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE img DROP img_path, CHANGE post_id post_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE img ADD img_path INT DEFAULT NULL, CHANGE post_id post_id INT NOT NULL');
