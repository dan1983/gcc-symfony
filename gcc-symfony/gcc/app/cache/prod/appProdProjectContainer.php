...
class appProdProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'img_manager' => 'getImgManagerService',
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'symfony_gcc', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), new \Doctrine\DBAL\Configuration(), $a, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_bfafeec6f5b3ba5dd3d2692026ed052fbe98e324e4594de191e8a4210e1ea867');
    ...
    /*
     * Gets the 'img_manager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Blog\CoreBundle\Services\ImgManager A Blog\CoreBundle\Services\ImgManager instance.
     */
    protected function getImgManagerService()
    {
        return $this->services['img_manager'] = new \Blog\CoreBundle\Services\ImgManager($this->get('doctrine.orm.default_entity_manager'));
    }
    ...
    {
        return $this->services['post_manager'] = new \Blog\CoreBundle\Services\PostManager($this->get('doctrine.orm.default_entity_manager'));
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('ff25d1ed9730be5145009b7f18b75a640d42c3c9');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('57aa59cbdda6b4.37573648')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'secret' => 'ff25d1ed9730be5145009b7f18b75a640d42c3c9',
            ...
            'kernel.secret' => 'ff25d1ed9730be5145009b7f18b75a640d42c3c9',
